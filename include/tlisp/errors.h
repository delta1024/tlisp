 ...
 * @returns The next error or NULL if que is empty. Error must be freed with tlisp_error_free() when you are done with it.
*/
 ...
 * @returns 0 or -1 if an error is encountered. Error valule is set in erno by the C stdlib.
 */
